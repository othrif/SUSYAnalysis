...
#file = TFile( '/UserDisk2/othrif/susy/data/Ximo/v26/user.jpoveda.t0711_v26.341177.aMcAtNloHerwigppEvtGen_UEEE5_CTEQ6L1_CT10ME_ttH125_in.DAOD_SUSY2.s2608_r6869_p2419_output.root.56607523/user.jpoveda.7157713._000001.output.root' )
#file = TFile( '/UserDisk2/othrif/data/Ximo/v28/user.jpoveda.t0717_v28.361102.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Wplustaunu.DAOD_SUSY2.s2576_r6725_p2419_output.root.59227309/user.jpoveda.7304204._000001.output.root' )
#file = TFile( '/UserDisk2/othrif/data/Ximo/v31/user.othrif.372511.MGPy8EG_A14N23LO_SM_GG_N2_SLN1_800_770_2L.a766_r6282_output.root')

#file = TFile('/UserDisk2/othrif/data/Ximo/v31/user.othrif.370122.MGPy8EG_A14N_GG_ttn1_1200_5000_855.s2608_r6282_output.root')
#file = TFile('/UserDisk2/othrif/data/Ximo/v28_3l/user.othrif.periodD.physics_Main.grp15_v01_p2425_output.root')

#file = TFile('/UserDisk2/othrif/data/Ximo/v32/user.othrif.410144.Sherpa_NNPDF30NNLO_ttW.a766_r6282_output.root')
#file = TFile('/UserDisk2/othrif/data/Ximo/v32/user.othrif.t0751_vTest207.410112.MadGraphPythia8EvtGen_A14NNPDF23LO_ttee_Np1.DAOD_SUSY2.s2608_r7725_p2613_output.root')

file = TFile('/UserDisk2/othrif/data/Ximo/v43/user.jpoveda.t0784_v43.410080.MadGraphPythia8EvtGen_A14NNPDF23_4topSM.DAOD_SUSY2.s2608_r7725_p2666_output.root/user.jpoveda.8956711._000001.output.root')
...
#        print branchname_mc, lname_mc, ltype_mc
...
#file = TFile( '/UserDisk2/othrif/susy/data/Ximo/v26/user.jpoveda.t0711_v26.periodJ.physics_Main.DAOD_SUSY2.grp15_v01_p2425_output.root.56957722/user.jpoveda.7157483._000043.output.root' )
#file = TFile( '/UserDisk2/othrif/data/Ximo/v28/user.jpoveda.t0717_v28_retry.periodG.physics_Main.DAOD_SUSY2.grp15_v01_p2425_output.root.59051807/user.jpoveda.7287148._000029.output.root' )
#file = TFile( '/UserDisk2/othrif/data/Ximo/v31/user.othrif.372511.MGPy8EG_A14N23LO_SM_GG_N2_SLN1_800_770_2L.a766_r6282_output.root' )

#file = TFile('/UserDisk2/othrif/data/Ximo/v32/user.othrif.410144.Sherpa_NNPDF30NNLO_ttW.a766_r6282_output.root')
#file = TFile('/UserDisk2/othrif/data/Ximo/v32/user.othrif.t0751_vTest207.410112.MadGraphPythia8EvtGen_A14NNPDF23LO_ttee_Np1.DAOD_SUSY2.s2608_r7725_p2613_output.root')

#file = TFile('/UserDisk2/othrif/data/Ximo/vopt/user.jpoveda.t0752_opt3.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.DAOD_SUSY2.s2608_r7725_p2613_output.root/user.jpoveda.8436277._000001.output.root')

file = TFile('/UserDisk2/othrif/data/Ximo/v43/user.jpoveda.t0784_v43.periodG.physics_Main.DAOD_SUSY2.grp15_v01_p2667_output.root/user.jpoveda.8955870._000001.output.root')
...
for x in range(0,len(type_mc)):
    ...
    if "Bool_t" in tmp or "bool" in tmp:
        ...
        type_ntp.append('I')
    elif  "float" in tmp or "Float_t" in tmp:
        type_ntp.append('F')
    elif "Double_t" in tmp or "double" in tmp:
        type_ntp.append('D')
    elif "ULong64_t" in tmp:
        type_ntp.append('l')
...
OldNtpBranches = open('MiniNtuple/OldNtpBranches.h', 'w')
...
OldNtpBranches.write('\n')
OldNtpBranches.write('using namespace std;\n')
OldNtpBranches.write('\n')
...
myevt = open('MiniNtuple/myevt.h','w')
...
for x in range(0,len(name_mc)):
    ...
    if "vector" not in tmp:
        myevt.write('  %s\t %s;\n' % (tmp,name_mc[x]))
    elif 'vector<double>' in tmp:
        if ("Jet_"in name_mc[x]):
            myevt.write('  Double_t\t %s[MAXJETS];\n' % (name_mc[x]))
        else: 
            myevt.write('  Double_t\t %s[MAXLEPT];\n' % (name_mc[x]))
    elif 'vector<float>' in tmp:
        if ("Jet_"in name_mc[x]):
...
OldNtpBranches_CXX = open('src/OldNtpBranches.cxx','w')
...
for x in range(0,len(name_mc)):
    OldNtpBranches_CXX.write('   fChain->SetBranchAddress("%s", &%s, &b_%s);\n' % (name_mc[x],name_mc[x],name_mc[x]))
...
################################################################################################### 
SetNewNtpBranches = open('src/SetNewNtpBranches.cxx','w')
...
for x in range(0,len(name_mc)):
#    print x, type_mc[x], type_ntp[x], name_mc[x]
    if "vector" in type_mc[x]:
        if "TruthJet_" in name_mc[x]:
            SetNewNtpBranches.write('%s[NTruthJet]/%s' % (name_mc[x],type_ntp[x]))
        elif "Jet_" in name_mc[x]:
            SetNewNtpBranches.write('%s[NJet]/%s' % (name_mc[x],type_ntp[x]))
        else:
            if "El_" in name_mc[x]:
                SetNewNtpBranches.write('%s[NEl]/%s' % (name_mc[x],type_ntp[x]))
            if "Mu_" in name_mc[x]:
                SetNewNtpBranches.write('%s[NMu]/%s' % (name_mc[x],type_ntp[x]))
            if "TruthL_" in name_mc[x]:
                SetNewNtpBranches.write('%s[NTruthL]/%s' % (name_mc[x],type_ntp[x]))
    else: 
...
SetNewNtpBranches.write('   b->GetLeaf("isMC")->SetAddress(&(evt->isMC));\n')
SetNewNtpBranches.write('   b->GetLeaf("sumWeight")->SetAddress(&(evt->sumWeight));\n')
SetNewNtpBranches.write('   b->GetLeaf("sumWeightsq")->SetAddress(&(evt->sumWeightsq));\n')
SetNewNtpBranches.write('   b->GetLeaf("rawEvents")->SetAddress(&(evt->rawEvents));\n')
for x in range(0,len(name_mc)):
    SetNewNtpBranches.write('   b->GetLeaf("%s")->SetAddress(&(evt->%s));\n' % (name_mc[x],name_mc[x]))
...
# src/TMiniNtuple.cxx 
################################################################################################### 
TMiniNtuple_CXX = open('src/TMiniNtuple.cxx','w')
...
TMiniNtuple_CXX.write('\n')
TMiniNtuple_CXX.write('#include "MiniNtuple/TMiniNtuple.h"\n')
...
TMiniNtuple_CXX.write('\n')
TMiniNtuple_CXX.write('\n')
TMiniNtuple_CXX.write('double weightedSum_events = 0;\n')
TMiniNtuple_CXX.write('double rawEvents = 0;\n')
TMiniNtuple_CXX.write('double weightedSumsq_events = 0;\n')
TMiniNtuple_CXX.write('\n')
TMiniNtuple_CXX.write('//__________________________________________________________________________\n')
TMiniNtuple_CXX.write('TMiniNtuple::TMiniNtuple(const std::string& name, ISvcLocator* pSvcLocator) :\n')
...
TMiniNtuple_CXX.write('TMiniNtuple::~TMiniNtuple() {\n')
TMiniNtuple_CXX.write('}\n')
TMiniNtuple_CXX.write('\n')
TMiniNtuple_CXX.write('//_____________________________________________________________________________\n')
...
TMiniNtuple_CXX.write('      //truth leptons\n')
TMiniNtuple_CXX.write('      j = 0;\n')
TMiniNtuple_CXX.write('      for (int i = 0; i < oldTree->NTruthL; i++) {\n')
TMiniNtuple_CXX.write('		if (j == MAXLEPT) {\n')
TMiniNtuple_CXX.write('		  std::cout << "WARNING: Too many leptons\\n";\n')
TMiniNtuple_CXX.write('		  break;\n')
TMiniNtuple_CXX.write('	      }\n')
...
TMiniNtuple_CXX.write('    j++;\n')
TMiniNtuple_CXX.write('   }\n')
TMiniNtuple_CXX.write('   evt->NTruthL = j;\n')
...
for x in range(0,len(name_mc)):
    if 'vector' in type_mc[x]:
        if 'Jet_' in name_mc[x] and 'TruthJet_' not in name_mc[x]:
            TMiniNtuple_CXX.write('    evt->%s[j] = oldTree->%s->at(i);\n' % (name_mc[x], name_mc[x] ) )
TMiniNtuple_CXX.write('    j++;\n')
TMiniNtuple_CXX.write('   }\n')
TMiniNtuple_CXX.write('   evt->NJet = j;\n')

TMiniNtuple_CXX.write('	//truth jets\n')
TMiniNtuple_CXX.write('	j = 0;\n')
TMiniNtuple_CXX.write('	for (int i = 0; i < oldTree->NTruthJet; i++) {\n')
TMiniNtuple_CXX.write('	  if (j == MAXJETS) {\n')
TMiniNtuple_CXX.write('		std::cout << "WARNING: Too many jets\\n";\n')
TMiniNtuple_CXX.write('		break;\n')
TMiniNtuple_CXX.write('	  }\n')
...
TMiniNtuple_CXX.write('    j++;\n')
TMiniNtuple_CXX.write('   }\n')
TMiniNtuple_CXX.write('   evt->NTruthJet = j;\n')
...
################################################################################################### 
TMiniNtuple_H = open('MiniNtuple/TMiniNtuple.h','w')
...
###################################################################################################
# Analyzer/Analyzer/myevt.h
################################################################################################### 

myevt_myAnalysis = open('myevt.h','w')


myevt_myAnalysis.write('//////////////////////////////////////////////////////////\n')
myevt_myAnalysis.write('// Author:      Othmane Rifki\n')
myevt_myAnalysis.write('// Contact:     othmane.rifki@cern.ch\n')
myevt_myAnalysis.write('// Description: Matches the branches in MiniNtuple\n')
myevt_myAnalysis.write('// Date %s\n' % strftime("%Y-%m-%d %H:%M:%S", gmtime()))
myevt_myAnalysis.write('//////////////////////////////////////////////////////////\n')
myevt_myAnalysis.write('\n')

myevt_myAnalysis.write('#ifndef MYEVT_N_HH_\n')
myevt_myAnalysis.write('#define MYEVT_N_HH_\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('//------------------------------------------------------------------------\n')
myevt_myAnalysis.write('//				-= Constants =-\n')
myevt_myAnalysis.write('//------------------------------------------------------------------------\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('const Int_t MAXJETS = 100;\n')
myevt_myAnalysis.write('const Int_t MAXLEPT = 25;\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('//------------------------------------------------------------------------\n')
myevt_myAnalysis.write('//				-= Structures =-\n')
myevt_myAnalysis.write('//------------------------------------------------------------------------\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('//This is the format used to store the reduced ntuple\n')
myevt_myAnalysis.write('//------------------------------------------------------------------------\n')
myevt_myAnalysis.write('\n')

myevt_myAnalysis.write('struct my_event {\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('  Bool_t isMC;\n')
myevt_myAnalysis.write('  Double_t           sumWeight;\n')
myevt_myAnalysis.write('  Double_t           sumWeightsq;\n')
myevt_myAnalysis.write('  Double_t           rawEvents;\n')
myevt_myAnalysis.write('  Int_t              trigRND;\n')

myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('\n')

myevt_myAnalysis.write('  //  Declaration of leaf types\n')

for x in range(0,len(name_mc)):
    tmp = type_mc[x]
    if "vector" not in tmp:
        myevt_myAnalysis.write('  %s\t %s;\n' % (tmp,name_mc[x]))
    elif 'vector<double>' in tmp:   
        if ("Jet_"in name_mc[x]):
            myevt_myAnalysis.write('  Double_t\t %s[MAXJETS];\n' % (name_mc[x]))
        else:
            myevt_myAnalysis.write('  Double_t\t %s[MAXLEPT];\n' % (name_mc[x]))
    elif 'vector<float>' in tmp:
        if ("Jet_"in name_mc[x]):
            myevt_myAnalysis.write('  Float_t\t %s[MAXJETS];\n' % (name_mc[x]))
        else: 
            myevt_myAnalysis.write('  Float_t\t %s[MAXLEPT];\n' % (name_mc[x]))
    elif 'vector<bool>' in tmp:
        if ("Jet_"in name_mc[x]):
            myevt_myAnalysis.write('  Bool_t\t %s[MAXJETS];\n' % (name_mc[x]))
        else: 
            myevt_myAnalysis.write('  Bool_t\t %s[MAXLEPT];\n' % (name_mc[x]))
    elif 'vector<int>' in tmp:
        if ("Jet_"in name_mc[x]):
            myevt_myAnalysis.write('  Int_t\t %s[MAXJETS];\n' % (name_mc[x]))
        else: 
            myevt_myAnalysis.write('  Int_t\t %s[MAXLEPT];\n' % (name_mc[x]))

myevt_myAnalysis.write('};\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('typedef struct my_event myevt;\n')



myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('// defines the lepton collection in the event\n')
myevt_myAnalysis.write('struct lepton_info {\n')
myevt_myAnalysis.write('  int num_leptons; \n')
myevt_myAnalysis.write('  int num_leptons_baseline; \n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('  int index[2 * MAXLEPT];\n')
myevt_myAnalysis.write('  Double_t pT[2 * MAXLEPT]; \n')
myevt_myAnalysis.write('  Double_t phi[2 * MAXLEPT]; \n')
myevt_myAnalysis.write('  Double_t eta[2 * MAXLEPT]; \n')
myevt_myAnalysis.write('  Double_t E[2 * MAXLEPT]; \n')
myevt_myAnalysis.write('  Double_t m[2 * MAXLEPT]; \n')
myevt_myAnalysis.write('  bool is_electron[2 * MAXLEPT];\n')
myevt_myAnalysis.write('  Double_t SFw[2 * MAXLEPT];\n')
myevt_myAnalysis.write('  float charge[2 * MAXLEPT];\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('  bool has_ee;\n')
myevt_myAnalysis.write('  bool has_em;\n')
myevt_myAnalysis.write('  bool has_mm;\n')
myevt_myAnalysis.write('  bool has_ss;\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('  bool has_Z;\n')
myevt_myAnalysis.write('  bool has_Z_SS;  \n')
myevt_myAnalysis.write('  bool has_Z_OS;\n')
myevt_myAnalysis.write('  bool has_Z_OS_SR3L3b;\n')
myevt_myAnalysis.write('  bool has_Z_lll;\n')
myevt_myAnalysis.write('  double MZ;\n')
myevt_myAnalysis.write('  double lowest_M;\n')
myevt_myAnalysis.write('  double m_ll[MAXLEPT]; // 0->12, 1->13, 2->23 or 2->14...\n')
myevt_myAnalysis.write('  int ind1;\n')
myevt_myAnalysis.write('  int ind2;\n')
myevt_myAnalysis.write('  int ind1_Mll;\n')
myevt_myAnalysis.write('  int ind2_Mll;\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('  bool is_fake_HF[2 * MAXLEPT];\n')
myevt_myAnalysis.write('  bool is_fake_LF[2 * MAXLEPT];\n')
myevt_myAnalysis.write('  bool is_chmisid[2 * MAXLEPT];\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('};\n')
myevt_myAnalysis.write('typedef struct lepton_info my_leptons;\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('// refers to individual lepton and not the collection \n')
myevt_myAnalysis.write('struct short_lep {\n')
myevt_myAnalysis.write('  bool is_electron;\n')
myevt_myAnalysis.write('  double pT;\n')
myevt_myAnalysis.write('  int ind;\n')
myevt_myAnalysis.write('};\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('// defines the jet collection in the event\n')
myevt_myAnalysis.write('struct jet_info{\n')
myevt_myAnalysis.write('  int num_jets;\n')
myevt_myAnalysis.write('  int index[MAXJETS];\n')
myevt_myAnalysis.write('  Double_t pT[MAXJETS]; \n')
myevt_myAnalysis.write('  Double_t phi[MAXJETS]; \n')
myevt_myAnalysis.write('  Double_t eta[MAXJETS]; \n')
myevt_myAnalysis.write('  Double_t E[MAXJETS]; \n')
myevt_myAnalysis.write('  Double_t MV2c20[MAXJETS];\n')
myevt_myAnalysis.write('};\n')
myevt_myAnalysis.write('typedef struct jet_info my_jets;\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('// refers to individual jet and not the collection \n')
myevt_myAnalysis.write('struct short_jet {\n')
myevt_myAnalysis.write('  double pt;\n')
myevt_myAnalysis.write('  int ind;\n')
myevt_myAnalysis.write('};\n')
myevt_myAnalysis.write('typedef struct short_jet srtJt;\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('struct duplicate {\n')
myevt_myAnalysis.write('  Double_t genFiltHT;\n')
myevt_myAnalysis.write('  Double_t genFiltMET;\n')
myevt_myAnalysis.write('  Int_t runNb;\n')
myevt_myAnalysis.write('  Int_t eventNumber;\n')
myevt_myAnalysis.write('}; \n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('#endif /* MYEVT_N_HH_ */\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('\n')
myevt_myAnalysis.write('\n')

myevt_myAnalysis.close()



###################################################################################################
# Analyzer/Root/declarestructs.cxx
################################################################################################### 
declarestructs = open('declarestructs.cxx','w')


declarestructs.write('//////////////////////////////////////////////////////////\n')
declarestructs.write('// Author:      Othmane Rifki\n')
declarestructs.write('// Contact:     othmane.rifki@cern.ch\n')
declarestructs.write('// Description: Matches the branches in MiniNtuple\n')
declarestructs.write('// Date %s\n' % strftime("%Y-%m-%d %H:%M:%S", gmtime()))
declarestructs.write('//////////////////////////////////////////////////////////\n')
declarestructs.write('\n')
declarestructs.write('\n')
declarestructs.write('\n')
declarestructs.write('// These are ROOT header files.\n')
declarestructs.write('#include "TTree.h"\n')
declarestructs.write('#include "TChain.h"\n')
declarestructs.write('#include "TBranch.h"\n')
declarestructs.write('#include "TLeaf.h"\n')
declarestructs.write('\n')
declarestructs.write('//here are the project-specific files\n')
declarestructs.write('#include "Analyzer/myevt.h"\n')
declarestructs.write('\n')
declarestructs.write('void declarestructs(TTree* tree, myevt* evt) {\n')
declarestructs.write('  TBranch *b;\n')
declarestructs.write('\n')
declarestructs.write('  if( (b = tree->GetBranch("myevt")) ) {\n')
declarestructs.write('\n')
declarestructs.write('b->GetLeaf("isMC")->SetAddress(&(evt->isMC));\n')
declarestructs.write('b->GetLeaf("sumWeight")->SetAddress(&(evt->sumWeight));\n')
declarestructs.write('b->GetLeaf("sumWeightsq")->SetAddress(&(evt->sumWeightsq));\n')
declarestructs.write('b->GetLeaf("rawEvents")->SetAddress(&(evt->rawEvents));\n')

for x in range(0,len(name_mc)):
    declarestructs.write('   b->GetLeaf("%s")->SetAddress(&(evt->%s));\n' % (name_mc[x],name_mc[x]))
