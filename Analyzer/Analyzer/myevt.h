...
struct my_event {
  ...
  Int_t      El_truthType[MAXLEPT];
  Int_t      El_truthOrigin[MAXLEPT];
  Int_t      El_bkgTruthType[MAXLEPT];
  Int_t      El_bkgTruthOrigin[MAXLEPT];
  Int_t El_bkgMotherPdgId[MAXLEPT];
  Int_t      El_firstEgMotherTruthType[MAXLEPT];
  Int_t      El_firstEgMotherTruthOrigin[MAXLEPT];
  Int_t      El_firstEgMotherPdgId[MAXLEPT];
  ...
  Float_t	 El_passChargeFlipTaggerBDTmedium[MAXLEPT];
  Float_t	 El_passChargeFlipTaggerBDTloose[MAXLEPT];
  Double_t	 El_SFweightCFT[MAXLEPT];
  Int_t	 NJet;
  Bool_t	 Jet_isSig[MAXJETS];
...
struct jet_info{
  ...
  bool is_btype_jet[MAXJETS];
  bool is_ctype_jet[MAXJETS];
  bool is_ltype_jet[MAXJETS];
};
