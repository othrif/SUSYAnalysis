...
if ! type -p "analyze-cutflow-v36" > /dev/null; then
...
#printf "\n\nRunning over data...\n\n"
#analyze-v36 $OUTPUT_FOLDER data $DATA
#printf "\nDone running over data...\n\n"

printf "Running over MC...\n"
analyze-cutflow-v36 $OUTPUT_FOLDER ttV $ttW $ttZ  2>&1 | tee $OUTPUT_PATH/OR-$2-ttV-v36.log

analyze-cutflow-v36 $OUTPUT_FOLDER powhegpythia6TTBar $powhegpythia6TTBar 2>&1 | tee $OUTPUT_PATH/OR-$2-ttbar-v36.log
