...
analyze $OUTPUT_FOLDER background $ttW $ttZ $WZ $ttH $Wh $Zh $ttWW $ttt $tttt $tZ $VVV $powhegpythia6TTBar $singletop $powhegpythia8Zjets $powhegpythia8Wjets $WWos $Wt $WWb $ZZb 

analyze $OUTPUT_FOLDER mc15a $WWa $ZZa
