...
#bkgFilesNames=["ttW.root", "ttZ.root", "WW.root", "WZ.root", "ZZ.root", "VVV.root", "tth.root", "Zh.root", "Wh.root", "ttWW.root", "3t.root", "4t.root", "tZ.root", "powhegpythia6TTBar.root", "singletop.root", 
#               "powhegpythia8Zjets.root", "Wjets.root"]
...
#    hFinalSig_Dm = TH2F("Significance_Dm","hFinalSig",40,600,2100,35,0,200)
    hFinalSig_Dm = TH2F("Significance_Dm","hFinalSig",40,600,2100,35,0,1200)
...
if not os.path.exists(directory):
    os.makedirs(directory)
lognamebest = directory+"/"+SigSample+"_SRbest.log"
fbest = open(lognamebest,'w')
...
#    print gridpoint
    sigResults=calcSig(gridpoint[0])
    if not sigResults:
...
#    f = open(directory+"/"+SigSample+"_"+mass1+"_"+mass2+".log",'w')
    f = open(logname,'w')
#    for i in range(0,len(sigResults)): 
    for i in range(0,20): 
        output_result = "zObs={sigResultsi0:8.2f}, sig={sigResultsi2:8.2f}, bkg={sigResultsi3:8.2f}, lepptmax1={sigResultsi10:8.2f}, lepptmin1={sigResultsi11:8.2f}, lepptmax2={sigResultsi12:8.2f}, lepptmin2={sigResultsi13:8.2f}, nbjets={sigResultsi17:8.2f}, njets={sigResultsi110:8.2f}, metmax={sigResultsi111:8.2f}, metmin={sigResultsi112:8.2f}, mtMmin={sigResultsi114:8.2f}, meff_cut={sigResultsi115:8.2f}, meff={sigResultsi116:8.2f}, metOmeff={sigResultsi117:8.2f}".format(sigResultsi0=sigResults[i][0],
                                       sigResultsi2=sigResults[i][2], 
                                       sigResultsi3=sigResults[i][3], 
                                       sigResultsi10=sigResults[i][1][0],
                                       sigResultsi11=sigResults[i][1][1],
                                       sigResultsi12=sigResults[i][1][2],
                                       sigResultsi13=sigResults[i][1][3],
                                       sigResultsi17=sigResults[i][1][7],
                                       sigResultsi110=sigResults[i][1][10],
                                       sigResultsi111=sigResults[i][1][11],
                                       sigResultsi112=sigResults[i][1][12],
                                       sigResultsi114=sigResults[i][1][14],
                                       sigResultsi115=sigResults[i][1][15],
                                       sigResultsi116=sigResults[i][1][16],
                                       sigResultsi117=sigResults[i][1][17])
    ...
    best_result= "{p1:f} {p2:f} {sig:f}".format(p1=gridpoint[1],p2=gridpoint[2],sig=sigResults[0][0])
    fbest.write(str(best_result))
    fbest.write("\n")
...
#    if (gridpoint[2]-(2*172.5))>0:
    hFinalSig_Dm.Fill(gridpoint[1],gridpoint[2],sigResults[0][0])
#        hFinalSig_Dm.Fill(gridpoint[1],gridpoint[2]-(2*172.5),sigResults[0][0])
...
#            bestCutHists_Dm[i][0].Fill(gridpoint[1],gridpoint[2]-(gridpoint[1]-2*172.5-25),sigResults[0][1][i])
        if (gridpoint[2]-(2*172.5))>0:
            bestCutHists_Dm[i][0].Fill(gridpoint[1],gridpoint[2]-(2*172.5),sigResults[0][1][i])


#drawHist(hFinalSig,hConfLevel,pointsplit[0]+"_"+pointsplit[1],True, True)
...
for hist in bestCutHists:
    ...
    if i in ignore_hist:
        continue
    drawHist(hist[0],hConfLevel,pointsplit[0],True)
#    drawHist(hist[0],hConfLevel,pointsplit[0]+"_"+pointsplit[1],True)
...
'''
        output_result = "zObs={sigResultsi0:8.2f}, sig={sigResultsi2:8.2f}, bkg={sigResultsi3:8.2f}, lepptmax={sigResultsi10:8.2f}, lepptmin={sigResultsi11:8.2f}, lepptmax={sigResultsi12:8.2f}, lepptmin={sigResultsi13:8.2f}, bjets={sigResultsi14:8.2f}, bjetptmax={sigResultsi15:8.2f}, bjetptmin={sigResultsi16:8.2f}, nbjets={sigResultsi17:8.2f}, jetptmax={sigResultsi18:8.2f}, jetptmin={sigResultsi19:8.2f}, njets={sigResultsi110:8.2f}, metmax={sigResultsi111:8.2f}, metmin={sigResultsi112:8.2f}, mtMmax={sigResultsi113:8.2f}, mtMmin={sigResultsi114:8.2f}, meff={sigResultsi115:8.2f}, metOmeff={sigResultsi116:8.2f}".format(sigResultsi0=sigResults[i][0],
                                       sigResultsi2=sigResults[i][2], 
                                       sigResultsi3=sigResults[i][3], 
                                       sigResultsi10=sigResults[i][1][0],
                                       sigResultsi11=sigResults[i][1][1],
                                       sigResultsi12=sigResults[i][1][2],
                                       sigResultsi13=sigResults[i][1][3],
                                       sigResultsi14=sigResults[i][1][4],
                                       sigResultsi15=sigResults[i][1][5],
                                       sigResultsi16=sigResults[i][1][6],
                                       sigResultsi17=sigResults[i][1][7],
                                       sigResultsi18=sigResults[i][1][8],
                                       sigResultsi19=sigResults[i][1][9],
                                       sigResultsi110=sigResults[i][1][10],
                                       sigResultsi111=sigResults[i][1][11],
                                       sigResultsi112=sigResults[i][1][12],
                                       sigResultsi113=sigResults[i][1][13],
                                       sigResultsi114=sigResults[i][1][14],
                                       sigResultsi115=sigResults[i][1][15],
                                       sigResultsi116=sigResults[i][1][16])
'''
