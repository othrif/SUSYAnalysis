...
void plotContours1(TString filename = "newOpt2",TString outname = "test1"){
  
  //  TH2F* hFinalSig = new TH2F("Significance","",50,600,2100,175,0,1700);
  TH2F* hFinalSig = new TH2F("Significance","",50,600,2100,175,345,1700);
  ...
  while(fList.getline(lineFromFile, 450))
	{
	  ...
	  //Find x,y:
		...
		if ((y-(x-2*172.5-25))>0){
		  ...
		  // hFinalSig->Fill(x,y-(2*172.5),sig);
  ...
  hFinalSig->Fill(600,400,3);
  hFinalSig->Fill(1550,345,1.64);
  hFinalSig->Fill(1200,855,1.64);
