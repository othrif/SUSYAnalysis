...
//const Double_t lumi = 3212.96 + 9994.73; //
...
struct distr_region {
  ...
  // SS/3L Incl channels
  distrSet fs_elel; // combined
  distrSet fs_elmu; // combined
  distrSet fs_mumu; // combined
...
struct distr_sig_region {
  ...
  // SS/3L Incl channels
  distrSigSet fs_elel; // combined
  distrSigSet fs_elmu; // combined
  distrSigSet fs_mumu; // combined
