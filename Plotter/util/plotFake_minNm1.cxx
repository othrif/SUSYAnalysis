...
void getData_Signature(distrSignature& set, string tag, const char* signal_name, Int_t ind, const char* syst_tag) {
  ...
  getData_Region(set.SR1, "SR3L0b1mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR2, "SR3L0b2mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR3, "SR3L1b1mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR4, "SR3L1b2mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR5, "SR0b1mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR6, "SR0b2mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR7, "SR1b1mMeff_" + tag, "", -1, syst_tag);
  getData_Region(set.SR8, "SR1b2mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR9, "SR3b1mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR10, "SR3b2mMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR11, "SRlowmMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR12, "SRhighmMET_" + tag, "", -1, syst_tag);
  getData_Region(set.SR13, "SR1b_3LSS_" + tag, "", -1, syst_tag);
  getData_Region(set.SR14, "SR1b_DD_lowmMeff_" + tag, "", -1, syst_tag);
  getData_Region(set.SR15, "SR1b_DD_highmMeff_" + tag, "", -1, syst_tag);
  getData_Region(set.SR16, "SR3b_DDmMeff_" + tag, "", -1, syst_tag);
  getData_Region(set.SR17, "SR1b_GGmMeff_" + tag, "", -1, syst_tag);
  getData_Region(set.SR18, "SRRPV0bmHT_" + tag, "", -1, syst_tag);
  getData_Region(set.SR19, "SRRPV3bmHT_" + tag, "", -1, syst_tag);
...
void getData_SigSignature(distrSigSignature& set, string tag, const char* signal_name, Int_t ind, const char* syst_tag) {
  ...
  getData_SigRegion(set.SR1, "SR3L0b1mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR2, "SR3L0b2mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR3, "SR3L1b1mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR4, "SR3L1b2mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR5, "SR0b1mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR6, "SR0b2mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR7, "SR1b1mMeff_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR8, "SR1b2mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR9, "SR3b1mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR10, "SR3b2mMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR11, "SRlowmMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR12, "SRhighmMET_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR13, "SR1b_3LSS_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR14, "SR1b_DD_lowmMeff_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR15, "SR1b_DD_highmMeff_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR16, "SR3b_DDmMeff_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR17, "SR1b_GGmMeff_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR18, "SRRPV0bmHT_" + tag, "", -1, syst_tag);
  getData_SigRegion(set.SR19, "SRRPV3bmHT_" + tag, "", -1, syst_tag);
...
void printBackgrounds(distrAll *my_set){
  ...
  fprintf(fp,"\nFakes & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ \\\\",  
  ...
  fprintf(fp,"\nCharge flip & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$  \\\\",
  ...
  fprintf(fp,"\nTotal & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ \\\\",
