...
int main(int argc, char **argv ) {
  ...
  TString path = "/afs/cern.ch/user/o/othrif/workarea/results/v48/jan16";
  TString tempname;
  //  TString ranges_ptmet[] = {"pt10","pt15","pt20","met0", "met150", "met200", "met250", "met300"};
  TString ranges_pt[] = {"pt20"}; //{"pt10","pt15","pt20"};
  TString channels[] = {"ee"}; //{"comb", "ee", "em", "mm"};
  TH1F * hist;//[8*4];
  ...
  for (int i = 0; i<1; i++)
	for (int j = 0; j<1; j++){
	  ...
	  TFile *f = new TFile(path+"/powhegpythia6TTBar.root");
	  tempname = "composition_el_"+ranges_pt[i]+"_powhegpythia6TTBar_mc_"+channels[j]+"_PRE_SS3L";
