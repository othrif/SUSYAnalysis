...
ClassImp(TruthReaderDD)


TruthReaderDD :: TruthReaderDD ()
{
...
EL::StatusCode TruthReaderDD :: setupJob (EL::Job& job)
{
...
EL::StatusCode TruthReaderDD :: histInitialize ()
{
  ...
  // Jet
  h_jetN   = new TH1F("h_jetN", "h_jetN;N_{jet};Events", 20, 0, 20);
  ...
  // Parton Level
  h_sd1Pt  = new TH1F("h_sd1Pt", "h_sd1Pt;Pt_{#tilde{d}_{1}};Events", 20, 0, 1500);
  h_sd1E   = new TH1F("h_sd1E", "h_sd1E;E_{#tilde{d}_{1}};Events", 20, 0, 2000);
  h_sd1Eta = new TH1F("h_sd1Eta", "h_sd1Eta;#eta_{#tilde{d}_{1}};Events", 20, -3, 3);
  h_sd1Phi = new TH1F("h_sd1Phi", "h_sd1Phi;#phi_{#tilde{d}_{1}};Events", 20, 0, 3.14); 
  wk()->addOutput (h_sd1Pt);
  wk()->addOutput (h_sd1E);
  wk()->addOutput (h_sd1Eta);
  wk()->addOutput (h_sd1Phi);

  h_sd2Pt  = new TH1F("h_sd2Pt", "h_sd2Pt;Pt_{#tilde{d}_{2}};Events", 20, 0, 1500);
  h_sd2E   = new TH1F("h_sd2E", "h_sd2E;E_{#tilde{d}_{2}};Events", 20, 0, 2000);
  h_sd2Eta = new TH1F("h_sd2Eta", "h_sd2Eta;#eta_{#tilde{d}_{2}};Events", 20, -3, 3);
  h_sd2Phi = new TH1F("h_sd2Phi", "h_sd2Phi;#phi_{#tilde{d}_{2}};Events", 20, 0, 3.14); 
  wk()->addOutput (h_sd2Pt);
  wk()->addOutput (h_sd2E);
  wk()->addOutput (h_sd2Eta);
  wk()->addOutput (h_sd2Phi);
  ...
  h_s1Pt  = new TH1F("h_s1Pt", "h_s1Pt;Pt_{s_{1}};Events", 20, 0, 1000);
  h_s1E   = new TH1F("h_s1E", "h_s1E;E_{s_{1}};Events", 20, 0, 1200);
  ...
  h_s2Pt  = new TH1F("h_s2Pt", "h_s2Pt;Pt_{s_{2}};Events", 20, 0, 1000);
  h_s2E   = new TH1F("h_s2E", "h_s2E;E_{s_{2}};Events", 20, 0, 1200);
  ...
  h_TrueBJetPt  = new TH1F("h_TrueBJetPt", "h_TrueBJetPt;Pt_{b-jet};Events", 20, 0, 800);
  h_TrueBJetE   = new TH1F("h_TrueBJetE", "h_TrueBJetE;E_{b-jet};Events", 20, 0, 1200);
...
EL::StatusCode TruthReaderDD :: fileExecute ()
{
...
EL::StatusCode TruthReaderDD :: changeInput (bool firstFile)
{
...
EL::StatusCode TruthReaderDD :: initialize ()
{
...
EL::StatusCode TruthReaderDD :: execute ()
{
  ...
  const xAOD::TruthParticle *sd1, *sd2, *top1, *top2, *s1, *s2, *b1, *b2, *w1, *w2;
  ...
  for( auto part_itr : *TruthParticles ){
	...
	part_itr->index() == 5 ){
      ...
      if( part_itr->index() == 4 ) sd1 = Particle;
      if( part_itr->index() == 5 ) sd2 = Particle;
	...
	ChildParticle = ChildParticle->child(0);
      ...
      const xAOD::TruthParticle* StrangeParticle = ChildParticle->child(1);
  ...
  h_sd1Pt->Fill( ( sd1->pt()) * 0.001);
  h_sd1E->Fill( ( sd1->e()) * 0.001);
  h_sd1Eta->Fill( sd1->eta() );
  h_sd1Phi->Fill( sd1->phi() );
  
  h_sd2Pt->Fill( ( sd2->pt()) * 0.001);
  h_sd2E->Fill( ( sd2->e()) * 0.001);
  h_sd2Eta->Fill( sd2->eta() );
  h_sd2Phi->Fill( sd2->phi() );
...
EL::StatusCode TruthReaderDD :: postExecute ()
{
...
EL::StatusCode TruthReaderDD :: finalize ()
{
...
EL::StatusCode TruthReaderDD :: histFinalize ()
{
  ...
  h_sd1Phi->SetMinimum(0.1); 
  h_sd2Phi->SetMinimum(0.1); 
